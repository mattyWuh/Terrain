...
public class ProTree: MonoBehaviour 
{
    ...
    void Start()
    {
        Color color = Random.ColorHSV(
            25.0f/360.0f, 140.0f/360.0f, 0.3f, 0.6f, 0.45f, 0.75f
        );
        woodMaterial = new Material(Shader.Find("Standard"));
        woodMaterial.SetColor("_Color", color);
    ...
    void ConstructLeaf()
    {
        ...
        Color color = Random.ColorHSV(
            75.0f/360.0f, 150.0f/360.0f, 0.4f, 0.8f, 0.45f, 0.70f, 0.0f, 0.5f
        );
        leafMaterial = new Material(Shader.Find("Standard"));
